...
class UpgradedUSBSecurity:
    def __init__(self):
        self.config_file = "upgraded_config.json"
...
class UpgradedUSBSecurityApp:
    def __init__(self, root):
        self.root = root
        self.security = UpgradedUSBSecurity()
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        self.root.title("Upgraded USB Physical Security v2.0")
    ...
    def setup_main_control(self):
        ...
        # Title
        title_label = tk.Label(self.main_frame, text="Upgraded USB Physical Security v2.0", 
    ...
    def setup_settings(self):
        ...
        # Security settings
        sec_frame = tk.LabelFrame(self.settings_frame, text="Security Settings", 
                                 font=("Arial", 12, "bold"), fg="#00ff00")
...
def main():
    ...
    root = tk.Tk()
    app = UpgradedUSBSecurityApp(root)
